...
export default function GameView() {
    ...
    const { playCard, drawCard, winGame, errorSound, turnNotify } = useSound();
    ...
    useEffect(() => {
        ...
        socket.on('game:update', (state) => {
             setGameState(prev => {
                 ...
                 const wasMyTurn = prev?.players[prev.currentTurnIndex]?.id === myId;
                 const isNowMyTurn = state.players[state.currentTurnIndex]?.id === myId;
