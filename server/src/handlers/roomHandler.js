    ...
    try {
        ...
        if (game && game.state === 'lobby') {
            ...
            if (game.players[0].socketId === socket.id) {
                ...
                game.betAmount = options.betAmount !== undefined ? options.betAmount : game.betAmount;
                game.startingHandSize = options.startingHandSize || game.startingHandSize;
                game.mercyLimit = options.mercyLimit || game.mercyLimit;
