...
const CARD_TYPES = {
  ...
  TARGETED_DRAW_TWO: 'targeted_draw_two',
  WILD_DRAW_FIFTEEN: 'wild_draw_fifteen'
};
...
function createDeck() {
  ...
  // Extra No Mercy Chaos
  for (const color of COLORS) {
      deck.push(createCard(CARD_TYPES.REVERSE_ALL, color));
      deck.push(createCard(CARD_TYPES.DOUBLE_SKIP, color));
  }
